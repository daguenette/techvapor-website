...
import { Ship, Caravan, Sparkles, Shield } from "lucide-react";
...
export default function BoatTrailerCleaningPage() {
  ...
  const carouselImages = [
    {
      src: "/Boat_02.jpg",
      alt: language === "fr" ? "Nettoyage de roulotte" : "Trailer cleaning",
    },
    {
      src: "/Boat_01.webp",
      alt: language === "fr" ? "Nettoyage de bateau" : "Boat cleaning",
    },
  ];
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-8 sm:py-10 md:py-12 lg:py-16 bg-gray-50">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Icon Grid - 2 cols on mobile, 3 on tablet, 4 on desktop */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-7 md:gap-8 mb-8">
              <div className="text-center">
                ...
                <p className="text-sm sm:text-base text-gray-700 font-medium px-2">
                  {language === "fr" ? "Nettoyage de bateaux" : "Boat cleaning"}
                </p>
              </div>
        ...
        <section
          id="service-inquiry"
          className="py-8 sm:py-10 md:py-12 lg:py-14 bg-gray-50"
        >
